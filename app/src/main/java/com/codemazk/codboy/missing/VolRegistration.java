...
public class VolRegistration extends AppCompatActivity {
    EditText name,phone,password,email,place;
    Button Signup;

    String emailInput,emailPattern,MobilePattern,nameinput,placeinput,phoneinput,passwordinput;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vol_registration);
        ...
        Signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(nameinput.isEmpty() ||emailInput.isEmpty()||phoneinput.isEmpty()||passwordinput.isEmpty()||placeinput.isEmpty()){
    ...
    public class ClsRegistraion extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            Json = jsonParser.makeServiceCall("http://project.codemazk.com/scms/missing/volender.php", readfromserver.GET, nameValuePairs);
            return null;
        }
        ...
        protected void onPreExecute() {
            // TODO Auto-generated method stub
            pg = new ProgressDialog(VolRegistration.this);
    ...
    void message(String Message, final int status){
        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(VolRegistration.this);
        ...
        alertDialogBuilder.setPositiveButton("ok",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        if(status==1){
                            Intent n=new Intent(VolRegistration.this,VolLogin.class);
                            startActivity(n);
                            finish();
                        }else{
