...
//                            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_finger1);
            ...
            public void onClick(View view) {
             ...
             //  Globle g=new Globle();
              //  g.minu_code1=isotem;
                ...
                Intent n=new Intent(AddFinger.this,MainActivity.class);
...
//                    isotem is byte value of fingerprints
                    ...
                    writeToFile(isotem,AddFinger.this,name.getText().toString());
  ...
  /*  private void CheckMatch(Context context){
   ...
   /*     }
    ...
    private void writeToFile(byte[] data, Context context, String UID) {
        try {
            ...
            File path = context.getExternalFilesDir(null);
                ...
                stream.close();
                Intent n = new Intent(context, com.codemazk.codboy.missing.aadarentry.MainActivity.class);
                n.putExtra("UID", UID);
                startActivity(n);
